      ...
      <div className="flex flex-col rounded-2xl bg-white md:flex-row md:items-center shadow-lg">
        <div className="md:p-5">
          <div className="text-left p-5 flex flex-col gap-4">
            <p className="text-3xl font-serif font-bold py-4">Log In</p>
            <p className="text-gray-500 max-w-sm">
              Log into your account to buy many items
            </p>
            <form onSubmit={handleSubmit}>
              ...
              <div className="flex flex-col md:flex-row md:justify-between items-center justify-center gap-7 mt-4">
                ...
                <button
                  type="submit"
                  className="w-full md:w-48 text-white bg-cyan-800 rounded-md border h-14 text-lg active:scale-105 hover:bg-cyan-600"
                >
                  Login
                </button>
              </div>
            ...
            <div className="flex flex-col md:flex-row mx-2 gap-4 md:justify-between">
              <div>
                <button className="w-full border active:scale-105 hover:bg-slate-200 flex flex-row items-center justify-center gap-2 p-2 md:w-52">
                  <img className="w-8 h-8" src="/facebook.png" alt="" />
                  <p className="text-gray-500">Facebook</p>
                </button>
              </div>
              <div>
                <button className="w-full border active:scale-105 hover:bg-slate-200 flex flex-row items-center justify-center gap-2 md:w-52 p-2">
